/***************************************************************************//**
 * @file   adxl345.h
 * @brief  Header file of ADXL345 Driver for MAX78000 (Maxim SDK).
...
#define ADXL345_ADDRESS_ALT	0x53 // Alternate address if SDO/ALT ADDRESS is grounded
 ...
 */
struct adxl345_dev {
	/** I2C Instance (e.g. MXC_I2C0, MXC_I2C1) */
